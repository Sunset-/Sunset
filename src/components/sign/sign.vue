<style lang="sass">
	.sign-container{
		...
		.sangto-login-container input:-moz-placeholder { color: #fff; }
		.sangto-login-container input:-ms-input-placeholder { color: #fff; }
		.sangto-login-container input::-webkit-input-placeholder { color: #fff; }
		...
		.sangto-login-container .connect a:hover { background-position: center bottom; }

		/*－－－增加部份的CSS－－－*/
		.sangto-login-container form,.sangto-login-container input,.sangto-login-container button{font-family:Microsoft YaHei,Segoe UI,Tahoma,Arial,Verdana,sans-serif; text-decoration:none; width:100%;}
		.sangto-login-container button.submit_button{ font-size:24px; letter-spacing:15px;}
		.sangto-login-container input.Captcha{ width:130px; float:left;}
	}
</style>
<template>
	<div class="sign-container">
		<div class="page-container sangto-login-container">
			<h1 class="text-white">妇产转诊后台管理平台</h1>
